...
Este repositorio contiene la prueba de despliegue del proyecto **Poliperros**, distribuido como un archivo ejecutable (.exe).

![poliperros](https://github.com/user-attachments/assets/14440509-296c-436b-855a-994999506b5a)

## 📝 Descripción 

Poliperros es una herramienta diseñada para la gestión de datos de los perros mascota de la **Escuela Politécnica Nacional del Ecuador**. La aplicación facilita el registro (Guardar), visualización (Mostrar), edición (Actualizar) y eliminación (Borrar).  
